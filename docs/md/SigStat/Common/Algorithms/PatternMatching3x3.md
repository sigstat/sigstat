...
| Name | Summary | 
| --- | --- | 
| PatternMatching3x3 ( [`Nullable`](https://docs.microsoft.com/en-us/dotnet/api/System.Nullable-1)[]\<[`Boolean`](https://docs.microsoft.com/en-us/dotnet/api/System.Boolean)> pattern ) | Initializes a new instance of the [SigStat.Common.Algorithms.PatternMatching3x3](https://github.com/sigstat/sigstat/tree/master/docs/md/SigStat/Common/Algorithms/PatternMatching3x3.md) class with given pattern. | 
