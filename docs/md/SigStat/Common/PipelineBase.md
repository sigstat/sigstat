...
| Name | Summary | 
| --- | --- | 
| PipelineBase (  ) | Initializes a new instance of the [SigStat.Common.PipelineBase](https://github.com/sigstat/sigstat/tree/master/docs/md/SigStat/Common/PipelineBase.md) class. | 
