...
namespace SigStat.Common.Loaders
{
    ...
    public class SigComp13JapaneseLoader : DataSetLoader
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SigComp13JapaneseLoader"/> class with specified database.
        /// </summary>
        ...
        public SigComp13JapaneseLoader(string databasePath, bool standardFeatures, Predicate<Signer> signerFilter)
        {
            DatabasePath = databasePath;
            StandardFeatures = standardFeatures;
