...
{
    class FusionPipelineBenchmark : PipelineBase
    {
        [Input]
        ...
        [Input]
        public SequentialTransformPipeline OfflinePipeline { get; set; }
        ...
        public FusionBenchmarkResults Execute()
        {
            ...
            var offlineSavers = FinalFusionPipelines.GetOfflineSavers();
            ...
            foreach (var offSigner in offlineSigners)
            {
                try
                {
                    ...
                    Parallel.ForEach(offSigner.Signatures, offSig =>
                    {
                        ...
                        offlineSavers.Transform(offSig);
